...
class Board(UserDict):
    ...
    #def count_X(self, ):
        ## check cell is instance of Cell
     #   print(isinstance(cell, Cell))

        # for each line value, replace cell keys with value in cell

     #   print({cell.value for cell in self.lines})
...
class Cell:
    ...
    def position(self, value):
        # position may be defined as tuple or string. E.g. (1, 2, 3) or '123'.
